...
export const tableDefinitions = {
  ...
  "board.history": defineTable("История исполнения поручения", ["acceptedAt", "description", "completedAt", "acceptedBy", "status", "meetingDate", "coExecutors", "deadline", "protocolNumber", "decisionNumber", "recurrence", "activeFrom", "activeTo", "createdBy", "updatedAt"]),
  "board.assignments": defineTable("Поручения Совета директоров", ["meetingDate", "description", "coExecutors", "deadline", "status", "protocolNumber", "decisionNumber", "recurrence", "activeFrom", "activeTo", "createdBy", "updatedAt"]),
