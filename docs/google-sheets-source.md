...
Если причина простоя, тип инцидента или текст закрытия содержит и `мех`, и `эл`, уведомление уйдёт обеим специализированным группам. Дубли адресов удаляются перед отправкой.
